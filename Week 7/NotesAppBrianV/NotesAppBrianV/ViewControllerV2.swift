...
//    
//    func loadNotes() {
//        if let loadedNotes:[Note] = NSArray(contentsOf: fileURL) as? [Note] {
//            notes = loadedNotes
...
//                
//                self.notes.insert(Note(title: title, content: content), at: 0)
...
//            row = sender as! Int
//            vc.titleText = notes[row].title
//            vc.contentText = notes[row].content
//            
//            vc.completionHandler = { title, content in
//                
//                self.notes[self.row].title = title
//                self.notes[self.row].content = content
//                self.notesTableView.reloadData()
//                
//                self.saveNotes()
//               
